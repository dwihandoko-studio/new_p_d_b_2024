            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-block d-sm-flex border-0 transactions-tab">
                        <div class="me-3">
                            <h4 class="card-title mb-2">Informasi Pendaftaran Jalur Zonasi</h4>
                            ...
                            <div id="accordion-one" class="accordion style-1">
                                <div class="accordion-item">
                                    <div class="accordion-header" data-bs-toggle="collapse" data-bs-target="#default_collapseOne2">
                                        <span>Jalur Zonasi merupakan jalur untuk calon siswa yang memprioritaskan jarak tempat tinggal berdasarkan dokumen kependudukan, terdekat dengan Sekolah yang dipilih dalam zonasi yang ditetapkan.</span>
