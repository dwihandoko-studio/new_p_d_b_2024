            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-block d-sm-flex border-0 transactions-tab">
                        <div class="me-3">
                            <h4 class="card-title mb-2">Informasi Pendaftaran Sekolah Swasta</h4>
                            ...
                            <div id="accordion-one" class="accordion style-1">
                                <div class="accordion-item">
                                    <div class="accordion-header" data-bs-toggle="collapse" data-bs-target="#default_collapseOne2">
                                        <span>Sekolah Swasta adalah sekolah yang di dirikan dan dikelola oleh Yayasan/Lembaga Pendidikan Swasta/Non-Pemerintahan.</span>
