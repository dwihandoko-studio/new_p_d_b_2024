                ...
                <div class="card">
                    ...
                    <div class="card-body tab-content p-0">
                        ...
                        <div class="image-container-panduan">
                            <img class="d-block w-100" src="<?= base_url() ?>/uploads/panduan/panitia/1.svg" alt="Image 1" id="current-image-panduan">
...
<script>
    ...
    const imagesPanduan = ['<?= base_url() ?>/uploads/panduan/panitia/1.svg', '<?= base_url() ?>/uploads/panduan/panitia/2.svg', '<?= base_url() ?>/uploads/panduan/panitia/3.svg', '<?= base_url() ?>/uploads/panduan/panitia/4.svg', '<?= base_url() ?>/uploads/panduan/panitia/5.svg', '<?= base_url() ?>/uploads/panduan/panitia/6.svg', '<?= base_url() ?>/uploads/panduan/panitia/7.svg', '<?= base_url() ?>/uploads/panduan/panitia/8.svg', '<?= base_url() ?>/uploads/panduan/panitia/9.svg', '<?= base_url() ?>/uploads/panduan/panitia/10.svg', '<?= base_url() ?>/uploads/panduan/panitia/11.svg', '<?= base_url() ?>/uploads/panduan/panitia/12.svg', '<?= base_url() ?>/uploads/panduan/panitia/13.svg', '<?= base_url() ?>/uploads/panduan/panitia/14.svg', '<?= base_url() ?>/uploads/panduan/panitia/15.svg', '<?= base_url() ?>/uploads/panduan/panitia/16.svg', '<?= base_url() ?>/uploads/panduan/panitia/17.svg']; // Add more image paths here
