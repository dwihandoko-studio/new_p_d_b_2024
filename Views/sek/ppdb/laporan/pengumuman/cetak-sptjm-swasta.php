    ...
    <div style="border: 0;">
        ...
        <div style="max-width: 100%; padding-left: 20px; padding-right: 20px;">
            ...
            <ol>
                ...
                <li>Verifikasi dokumen pendaftaran penerimaan peserta didik baru TA. 2024/2025 Sekolah Swasta dilaksanakan oleh Panitia PPDB Sekolah.</li>
                <li>Dari hasil proses Penerimaan Peserta Didik Baru (PPDB) Tahun Pelajaran 2024/2025, dilaksanakan sesuai jadwal yang telah ditetapkan, selanjutnya data peserta PPDB TP. 2024/2025 yang terlampir pada surat ini adalah peserta yang lolos dan tidak lolos proses seleksi PPDB TP. 2024/2025 di <?= $sekolah->nama ?>.</li>
...
$dompdf->render();
$dompdf->stream("SPTJM_SWASTA_" . $sekolah->npsn . ".pdf", array("Attachment" => false));
exit(0);
?>