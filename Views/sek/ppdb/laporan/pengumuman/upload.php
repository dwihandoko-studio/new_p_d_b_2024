        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mt-3">
                            <label for="_file" class="form-label">Upload SPTJM: </label>
                            <input class="form-control" type="file" id="_file" name="_file" onFocus="inputFocus(this);" accept="image/*, .pdf">
    ...
    if (form) {
        form.addEventListener('submit', function(event) { // Prevent default form submission
            ...
            if (validateForm(this)) {
                ...
                Swal.fire({
                    title: 'Apakah anda yakin ingin mengupload file ini?',
                    text: "Upload: File",
