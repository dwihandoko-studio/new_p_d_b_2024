...
<?php if (count($datas) > 0) { ?>
    <div class="tombol-simpan-data" style="display: block;">
        ...
        <a class="btn btn-sm btn-warning waves-effect waves-light" href="javascript:actionAjukanProsesTagihan(this);"><i class="fas fa-map-signs font-size-16 align-middle me-2"></i> AJUKAN PROSES TAGIHAN</a>
    </div>
<?php } else { ?>
