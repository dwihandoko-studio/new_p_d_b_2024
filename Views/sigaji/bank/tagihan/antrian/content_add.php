    ...
    <div class="tombol-simpan-data" style="display: block;">
        <?php if (isset($prosesed_ajuan)) { ?>
            <?php if ($prosesed_ajuan > 0) { ?>
                <a class="btn btn-sm btn-primary waves-effect waves-light" href="./download?tb=<?= $tw_active ?>"><i class="fas fa-download font-size-16 align-middle me-2"></i> DOWNLOAD DATA USULAN TAGIHAN</a>
            <?php } else { ?>
