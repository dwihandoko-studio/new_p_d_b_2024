        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">DATA DETAIL TAGIHAN BANK TERTOLAK || TAK TERTAGIH</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Detail Tagihan BANK Tertolak || Tak Tertagih Tahun <?= isset($tw) ? $tw->tahun : '' ?> Bulan <?= isset($tw) ? $tw->bulan_name : '' ?></h4>
