        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">DATA VERIFIKASI TAGIHAN BANK</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Verifikasi Tagihan BANK</h4>
                        ...
                        <table id="data-datatables" class="table table-bordered dt-responsive  nowrap w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th data-orderable="false">Nama Bank</th>
                                    <th data-orderable="false">Tahun Bulan</th>
                                    <th align="center">Jumlah Pegawai</th>
