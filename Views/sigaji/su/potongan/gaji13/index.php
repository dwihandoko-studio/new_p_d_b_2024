        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">DATA POTONGAN GAJI 13</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Potongan GAJI 13</h4>
                                <div><a class="btn btn-sm btn-primary waves-effect waves-light" href="javascript:actionGenerate(this);"><i class="bx bx-shape-circle font-size-16 align-middle me-2"></i> Generate Potongan Gaji 13</a>&nbsp;&nbsp;</div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
...
<script>
    function actionGenerate(event) {
        Swal.fire({
            title: 'Apakah anda yakin ingin mengenerate potongan untuk Gaji 13 Tahun <?= $tw->tahun ?> - Bulan <?= $tw->bulan ?>?',
            text: "Generate Potongan Gaji 13 : Tahun <?= $tw->tahun ?> - Bulan <?= $tw->bulan ?> ",
