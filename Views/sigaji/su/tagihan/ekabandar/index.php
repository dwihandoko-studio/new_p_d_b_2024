        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">DATA TAGIHAN BANK EKA BANDAR JAYA</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Tagihan Bank Eka Bandar Jaya</h4>
...
<script>
    ...
    function actionHapus(id, nama) {
        Swal.fire({
            ...
            text: "Hapus Tagihan Bank Eka Bandar Jaya : " + nama,
