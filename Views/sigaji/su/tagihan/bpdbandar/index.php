        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">DATA TAGIHAN BPD BANDAR JAYA</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Tagihan BPD Bandar Jaya</h4>
...
<script>
    ...
    function actionHapus(id, nama) {
        Swal.fire({
            ...
            text: "Hapus Tagihan BPD Bandar Jaya : " + nama,
