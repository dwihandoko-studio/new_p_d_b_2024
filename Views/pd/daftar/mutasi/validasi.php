<form id="formEditPassData" class="formEditPassData" action="./passSave" method="post">
    ...
    <div class="modal-body">
        <p><i>Validasi Dokumen Syarat Pendaftaran PPDB Jalur Mutasi Ke <b><?= $nama_sekolah ?></b></i></p>
        <div class="row">
            <div class="col-9 col-12">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-responsive-sm">
                        ...
                        <tr>
                            <td>5.</td>
                            <td>Surat Mutasi Kerja Orang Tua / Wali</td>
                            <td>
                                <div class="radio">
                                    <label for="_mutasi"><input type="radio" id="_mutasi" name="_mutasi" value="1"> Ada</label>
                                </div>
                            </td>
                            <td>
                                <div class="radio">
                                    <label for="_mutasi_no"><input type="radio" id="_mutasi_no" name="_mutasi" value="0"> Tidak</label>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="col-12 mt-4">
            <div class="form-check custom-checkbox mb-3">
                ...
                <label class="form-check-label" for="_has_confirmed">Saya menyatakan dengan sesungguhnya, bahwa saya memiliki
                    dokumen syarat PPDB Jalur Mutasi yang saya pilih. Dan
...
<script>
    ...
    function validateForm(formElement) {
        ...
        const selectedMutasi = document.querySelector('input[type="radio"][name^="_mutasi"]:checked');
        ...
        if (!(selectedMutasi)) {
            Swal.fire(
                'Peringatan!',
                "Silahkan pilih validasi surat mutasi kerja.",
                'warning'
            ).then((valRes) => {});
            return false;
        }
