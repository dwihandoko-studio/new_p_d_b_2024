                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                ...
                                <input type="number" id="__pa_1" name="__pa_1" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">PKn</span>
                                <input type="number" id="__pkn_1" name="__pkn_1" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">Bahasa Indonesia</span>
                                <input type="number" id="__bi_1" name="__bi_1" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">MTK</span>
                                <input type="number" id="__mtk_1" name="__mtk_1" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPA</span>
                                <input type="number" id="__ipa_1" name="__ipa_1" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPS</span>
                                <input type="number" id="__ips_1" name="__ips_1" class="form-control" value="" required />
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">Pendidikan Agama</span>
                                <input type="number" id="__pa_2" name="__pa_2" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">PKn</span>
                                <input type="number" id="__pkn_2" name="__pkn_2" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">Bahasa Indonesia</span>
                                <input type="number" id="__bi_2" name="__bi_2" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">MTK</span>
                                <input type="number" id="__mtk_2" name="__mtk_2" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPA</span>
                                <input type="number" id="__ipa_2" name="__ipa_2" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPS</span>
                                <input type="number" id="__ips_2" name="__ips_2" class="form-control" value="" required />
                            </div>
                        </div>
                    </div>
                    <div class="col-6 mt-2">
                        ...
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">Pendidikan Agama</span>
                                <input type="number" id="__pa_3" name="__pa_3" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">PKn</span>
                                <input type="number" id="__pkn_3" name="__pkn_3" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">Bahasa Indonesia</span>
                                <input type="number" id="__bi_3" name="__bi_3" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">MTK</span>
                                <input type="number" id="__mtk_3" name="__mtk_3" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPA</span>
                                <input type="number" id="__ipa_3" name="__ipa_3" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPS</span>
                                <input type="number" id="__ips_3" name="__ips_3" class="form-control" value="" required />
                            </div>
                        </div>
                    </div>
                    <div class="col-6 mt-2">
                        ...
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">Pendidikan Agama</span>
                                <input type="number" id="__pa_4" name="__pa_4" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">PKn</span>
                                <input type="number" id="__pkn_4" name="__pkn_4" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">Bahasa Indonesia</span>
                                <input type="number" id="__bi_4" name="__bi_4" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">MTK</span>
                                <input type="number" id="__mtk_4" name="__mtk_4" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPA</span>
                                <input type="number" id="__ipa_4" name="__ipa_4" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPS</span>
                                <input type="number" id="__ips_4" name="__ips_4" class="form-control" value="" required />
                            </div>
                        </div>
                    </div>
                    <div class="col-6 mt-2">
                        ...
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">Pendidikan Agama</span>
                                <input type="number" id="__pa_5" name="__pa_5" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">PKn</span>
                                <input type="number" id="__pkn_5" name="__pkn_5" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">Bahasa Indonesia</span>
                                <input type="number" id="__bi_5" name="__bi_5" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">MTK</span>
                                <input type="number" id="__mtk_5" name="__mtk_5" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPA</span>
                                <input type="number" id="__ipa_5" name="__ipa_5" class="form-control" value="" required />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group   input-primary">
                                <span class="input-group-text" style="width: 110px; min-width: 110px;min-width: 110px;">IPS</span>
                                <input type="number" id="__ips_5" name="__ips_5" class="form-control" value="" required />
                            </div>
                        </div>
                    </div>
                    <div class="col-6 mt-2">
            ...
            <div class="col-9 col-12 mt-3">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-responsive-sm">
                        ...
                        <tr>
                            <td>5.</td>
                            <td>Rapor 5 Semester & Surat Keterangan<br />Peringkat Nilai Rapor</td>
                            <td>
                                <div class="radio">
                                    <label for="_rapor"><input type="radio" id="_rapor" name="_rapor" value="1"> Ada</label>
                                </div>
                            </td>
                            <td>
                                <div class="radio">
                                    <label for="_rapor_no"><input type="radio" id="_rapor_no" name="_rapor" value="0"> Tidak</label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>6.</td>
                            <td>Dokumen Prestasi / Juara</td>
                            <td>
                                <div class="radio">
...
<script>
    ...
    function validateForm(formElement) {
        ...
        const selectedRapor = document.querySelector('input[type="radio"][name^="_rapor"]:checked');
        ...
        const nilaiRata2 = formElement.querySelector('#_nilai_rata2');
        const prestasiDimiliki = formElement.querySelector('#_prestasi_dimiliki');

        if ((nilaiRata2.value === "" || nilaiRata2 === undefined)) {
            Swal.fire(
                'Failed!',
                "Silahkan masukan nilai rapor selama 5 semester dan hitung nilai rata-rata terlebih dahulu.",
                'warning'
            ).then((valR) => {
                // latitudeInput.focus();
            });
        ...
        if (!(selectedRapor)) {
            Swal.fire(
                'Peringatan!',
                "Silahkan pilih validasi kepemilikan rapor 5 semester & surat keterangan peringkat nilai rapor.",
                'warning'
            ).then((valRes) => {});
            return false;
        }
