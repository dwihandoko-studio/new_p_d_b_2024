        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mt-3">
                            <label for="_file" class="form-label">Upload Data Sekolah: </label>
    ...
    function displayTableUpload(data) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    title: 'Apakah anda yakin ingin mengupload data sekolah ini?',
                    text: `Upload Data Sekolah Untuk :  ${dataJsonUpload.length} Sekolah`,
                    showCancelButton: true,
                    icon: 'question',
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
