                    ...
                    <?php if (isset($user)) { ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-verifikasi">
                                ...
                                <a href="<?= base_url('situgu/opk/verifikasi/spjtpg') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "opk" && $uri->getSegment(3) == "verifikasi" && $uri->getSegment(4) == "spjtpg") ? ' active-menu-href' : '' ?>" key="t-verifikasi-spjtpg">SPJ Tunjangan Profesi Guru</a>
