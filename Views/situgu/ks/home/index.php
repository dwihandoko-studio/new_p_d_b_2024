    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php if (!$data) { ?>
                    <?php $getStatusIndikator = getStatusIndikatorUsulan($data_antrian_tamsil_transfer, $data_antrian_tpg_transfer, $data_antrian_pghm_transfer, $data_antrian_tamsil, $data_antrian_tpg, $data_antrian_pghm); ?>
                    <?php if ($getStatusIndikator) { ?>
                        <?php if ($getStatusIndikator->jenis == "tamsil_transfer") { ?>
                            <?php if ($getStatusIndikator->data->status_usulan == 0 || $getStatusIndikator->data->status_usulan == 1) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="hori-timeline">
                                            <div class="owl-carousel owl-theme  navs-carousel events" id="timeline-carousel">
                                                <div class="item event-list">
                                                    <div>
                                                        <div class="event-date">
                                                            <div class="text-primary mb-1"><?= $getStatusIndikator->data->created_at ?></div>
                                                            <h5 class="mb-4">1</h5>
                                                        </div>
                                                ...
                                                <div class="item event-list">
                                                    <div>
                                                        <div class="event-date">
                                                            <div class="text-primary mb-1"><?= $getStatusIndikator->data->date_approve_ks ?></div>
                                                            <h5 class="mb-4">2</h5>
                                                        </div>
                                                        <div class="event-down-icon">
                                                ...
                                                <div class="item event-list">
                                                    <div>
                                                        <div class="event-date">
                                                            <div class="text-primary mb-1"><?= $getStatusIndikator->data->date_approve_sptjm ?></div>
                                                            <h5 class="mb-4">3</h5>
                                                        </div>
                                                        <div class="event-down-icon">
                                                            <i class="bx bx-check-circle h1 text-success"></i>
                            ...
                            <?php } else if ($getStatusIndikator->data->status_usulan == 2) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Progress Pengajuan Usulan Tunjangan Tamsil Anda</h4>
                                        ...
                                        <div class="hori-timeline">
                                            <div class="owl-carousel owl-theme  navs-carousel events" id="timeline-carousel">
                                                ...
                                                <div class="item event-list">
                                                    <div>
                                                        <div class="event-date">
                                                            <div class="text-primary mb-1"><?= $getStatusIndikator->data->date_approve ?></div>
                                                            <h5 class="mb-4">4</h5>
                                                        </div>
                                                        <div class="event-down-icon">
                                                            <i class="bx bx-check-circle h1 text-success"></i>
                            ...
                            <?php } else if ($getStatusIndikator->data->status_usulan == 3) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Progress Pengajuan Usulan Tunjangan Tamsil Anda</h4>
                                        ...
                                        <div class="hori-timeline">
                                            <div class="owl-carousel owl-theme  navs-carousel events" id="timeline-carousel">
                                                ...
                                                <div class="item event-list">
                                                    <div>
                                                        <div class="event-date">
                                                            <div class="text-primary mb-1"><?= $getStatusIndikator->data->date_reject ?></div>
                                                            <h5 class="mb-4">4</h5>
                                                        </div>
                                                        <div class="event-down-icon">
                                                        ...
                                                        <div class="mt-3 px-3">
                                                            <p class="text-muted">Verifikasi dan Validasi oleh Admin. (Ditolak Karena : <?= $getStatusIndikator->data->keterangan_reject ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <?php } else if ($getStatusIndikator->data->status_usulan == 4) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Progress Pengajuan Usulan Tunjangan Tamsil Anda</h4>
                                            ...
                                            <div class="owl-carousel owl-theme  navs-carousel events" id="timeline-carousel">
                                                ...
                                                <div class="item event-list">
                                                    <div>
                                                        ...
                                                        <div class="mt-3 px-3">
                                                            <p class="text-muted">Proses Transfer Pembayaran Tunjangan. (Ditolak Karena : <?= $getStatusIndikator->data->keterangan_reject ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <?php } else if ($getStatusIndikator->data->status_usulan == 5) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Progress Pengajuan Usulan Tunjangan Tamsil Anda</h4>
                                        ...
                                        <div class="hori-timeline">
                                            <div class="owl-carousel owl-theme  navs-carousel events" id="timeline-carousel">
                                                ...
                                                <div class="item event-list">
                                                    <div>
                                                        <div class="event-date">
                                                            <div class="text-primary mb-1"><?= $getStatusIndikator->data->date_prosestransfer ?></div>
                                                            <h5 class="mb-4">5</h5>
                                                        </div>
                                                        <div class="event-down-icon">
                                                            <i class="bx bx-check-circle h1 text-success"></i>
                            ...
                            <?php if ($getStatusIndikator->data->status_usulan == 0 || $getStatusIndikator->data->status_usulan == 1 || $getStatusIndikator->data->status_usulan == 2 || $getStatusIndikator->data->status_usulan == 5) { ?>
                            <?php } else { ?>
                                <div class="card">
                                    <div class="card-body">
                            ...
                            <?php } ?>
                        <?php } else if ($getStatusIndikator->jenis == "tpg_transfer") { ?>
                            <?php if ($getStatusIndikator->data->status_usulan == 0 || $getStatusIndikator->data->status_usulan == 1) { ?>
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="owl-carousel owl-theme  navs-carousel events" id="timeline-carousel">
                                                ...
                                                <div class="item event-list">
                                                    <div>
                                                        ...
                                                        <div class="mt-3 px-3">
                                                            <p class="text-muted">Proses Matching Dengan SIMTUN. (Ditolak karena : <?= $getStatusIndikator->data->keterangan_reject ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="item event-list">
                                        ...
                                        <div class="hori-timeline">
                                            <div class="owl-carousel owl-theme  navs-carousel events" id="timeline-carousel">
                                                ...
                                                <div class="item event-list">
                                                    <div>
                                                        <div class="event-date">
                                                            <div class="text-primary mb-1"><?= $getStatusIndikator->data->date_matching ?></div>
                                                            <h5 class="mb-4">5</h5>
                                                        </div>
                                                        <div class="event-down-icon">
                                                            <i class="bx bx-check-circle h1 text-success"></i>
                            ...
                            <?php } else if ($getStatusIndikator->data->status_usulan == 6) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Progress Pengajuan Usulan TPG Anda</h4>
                                        ...
                                        <div class="hori-timeline">
                                            <div class="owl-carousel owl-theme  navs-carousel events" id="timeline-carousel">
                                                ...
                                                <div class="item event-list">
                                                    <div>
                                                        <div class="event-date">
                                                            <div class="text-primary mb-1"><?= $getStatusIndikator->data->date_terbitsk ?></div>
                                                            <h5 class="mb-4">6</h5>
                                                        </div>
                                                        <div class="event-down-icon">
                                                            <i class="bx bx-check-circle h1 text-success"></i>
                            ...
                            <?php } else if ($getStatusIndikator->data->status_usulan == 7) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Progress Pengajuan Usulan TPG Anda</h4>
                            ...
                            <?php if ($getStatusIndikator->data->status_usulan == 0 || $getStatusIndikator->data->status_usulan == 1 || $getStatusIndikator->data->status_usulan == 2 || $getStatusIndikator->data->status_usulan == 5 || $getStatusIndikator->data->status_usulan == 6 || $getStatusIndikator->data->status_usulan == 7) { ?>
                            <?php } else { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-grid gap-2">
                            ...
                            <?php } ?>
                        <?php } else if ($getStatusIndikator->jenis == "pghm_transfer") { ?>
                            <?php if ($getStatusIndikator->data->status_usulan == 0 || $getStatusIndikator->data->status_usulan == 1) { ?>
                                <div class="card">
                                    <div class="card-body">
                            ...
                            <?php } ?>
                        <?php } else if ($getStatusIndikator->jenis == "tamsil") { ?>
                            <?php if ($getStatusIndikator->data->status_usulan == 0 || $getStatusIndikator->data->status_usulan == 1) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Progress Pengajuan Usulan Tunjangan Tamsil Anda</h4>
                            ...
                            <?php } ?>
                        <?php } else if ($getStatusIndikator->jenis == "tpg") { ?>
                            <?php if ($getStatusIndikator->data->status_usulan == 0 || $getStatusIndikator->data->status_usulan == 1) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Progress Pengajuan Usulan TPG Anda</h4>
                            ...
                            <?php } ?>
                        <?php } else if ($getStatusIndikator->jenis == "pghm") { ?>
                            <?php if ($getStatusIndikator->data->status_usulan == 0 || $getStatusIndikator->data->status_usulan == 1) { ?>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Progress Pengajuan Usulan Tunjangan PGHM Anda</h4>
