        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">REFERENSI TAHUN TW</h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-6">
                                    <h4 class="card-title">Data Referensi Tahun TW</h4>
                                </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH REFERENSI TAHUN TW');
    ...
    function actionActived(id, tahun, tw) {
        Swal.fire({
            title: 'Apakah anda yakin ingin mengaktifkan Tahun TW ini?',
            text: "Aktifkan Tahun TW : " + tahun + "/" + tw,
