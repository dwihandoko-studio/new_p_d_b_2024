<?php if (isset($tw)) { ?>
    <form id="formAddModalData" action="./uploadSave" method="post" enctype="multipart/form-data">
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-8">
                    <div class="col-3">
                        <label for="_tw" class="form-label">Tahun TW Sekarang:</label>
                        <select class="form-control" id="_tw_sekarang" name="_tw_sekarang" required>
                            <option value="">--------------------------------------------</option>
                            <?php if (isset($tws)) {
                                if (count($tws) > 0) {
                        ...
                        <div class="help-block _tw_sekarang"></div>
                    </div>
                    <div class="col-3">
                        <label for="_tw" class="form-label">Tahun TW Sebelumnya:</label>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mt-3">
                                <label for="_file" class="form-label">Upload Data Lanjutan Triwulan: </label>
    ...
    <script>
        ...
        $("#formAddModalData").on("submit", function(e) {
            ...
            const tw_sekarang = document.getElementsByName('_tw_sekarang')[0].value;
            ...
            formUpload.append('tw', tw_sekarang);
            formUpload.append('current_tw', tw);
