        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">SETTING GRANTED CREATE ADUAN</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <?php if ($status_syn > 0) { ?>
                                <li class="breadcrumb-item"><a href="javascript:actionDisabled(this);" class="btn btn-danger btn-rounded waves-effect waves-light">Non Aktifkan Grant Create Aduan</a></li>
                            <?php } else { ?>
                                <li class="breadcrumb-item"><a href="javascript:actionActived(this);" class="btn btn-success btn-rounded waves-effect waves-light">Aktifkan Grant Create Aduan</a></li>
                            <?php } ?>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">STATUS GRANTED CREATE ADUAN</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
<script>
    function actionDisabled(event) {
        Swal.fire({
            title: 'Apakah anda yakin ingin menonaktifkan granted create aduan?',
            text: "Nonaktifkan Grant Create Aduan : SITUGU",
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('situgu/su/setting/grantedcreateaduan/disabled') ?>",
                    type: 'POST',
                    data: {
                        id: 'disable',
                    },
    ...
    function actionActived(event) {
        Swal.fire({
            title: 'Apakah anda yakin ingin mengaktifkan Grant Create Aduan?',
            text: "Aktifkan Grant Create Aduan : SITUGU",
            showCancelButton: true,
            icon: 'question',
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('situgu/su/setting/grantedcreateaduan/active') ?>",
                    type: 'POST',
                    data: {
                        id: 'active',
                    },
