        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">GRANTED CREATE USULAN</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript:actionAdd(this);" class="btn btn-primary btn-rounded waves-effect waves-light">Add Grant Access Usulan Situgu</a></li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Create Usulan</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
<script>
    function actionHapus(id, nama, nuptk) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('situgu/su/setting/grantedusulancustom/delete') ?>",
                    type: 'POST',
                    data: {
                        id: id,
                    },
    ...
    function actionAdd(event) {
        $.ajax({
            url: "<?= base_url('situgu/su/setting/grantedusulancustom/add') ?>",
            type: 'POST',
            data: {
                action: 'Add',
            },
    ...
    $(document).ready(function() {
        ...
        let tableDatatables = $('#data-datatables').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('situgu/su/setting/grantedusulancustom/getAll') ?>",
                "type": "POST",
