        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">ACCESS SIGAJI</h4>
...
<script>
    function actionHapus(id, nama, nuptk) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('situgu/su/setting/accessgaji/delete') ?>",
                    type: 'POST',
                    data: {
                        id: id,
                    },
    ...
    function actionAdd(event) {
        $.ajax({
            url: "<?= base_url('situgu/su/setting/accessgaji/add') ?>",
            type: 'POST',
            data: {
                action: 'Add',
            },
    ...
    $(document).ready(function() {
        ...
        let tableDatatables = $('#data-datatables').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('situgu/su/setting/accessgaji/getAll') ?>",
                "type": "POST",
