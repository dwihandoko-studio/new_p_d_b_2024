        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">SPTJM VERIFIKASI SPJ TAMSIL</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript:actionAdd(this);" class="btn btn-primary btn-rounded waves-effect waves-light">BUAT SPTJM VERIFIKASI SPJ TAMSIL</a></li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data SPTJM Verifikasi SPJ Tamsil</h4>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
...
<script>
    function actionDetail(id, tahun, tw) {
        if (id === undefined || id === "") {
            Swal.fire(
                'Peringatan!',
                "Kode Verifikasi SPJ belum dibuat, silahkan klik Download terlebih dahulu.",
                'warning'
            );
            return;
        }
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('DETAIL SPTJM VERIFIKASI SPJ TAMSIL');
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailpilihModalLabel').html('PILIH TRIWULAN SPTJM VERIFIKASI SPJ TAMSIL');
    ...
    //                 );
    //             } else {
    //                 $('#content-detailModalLabel').html('BUAT SPTJM VERIFIKASI SPJ TAMSIL');
    //                 $('.contentBodyModal').html(resul.data);
    //                 $('.content-detailModal').modal({
    //                     backdrop: 'static',
    //                     keyboard: false,
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('Download SPTJM Verifikasi SPJ TAMSIL.');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('Edit Lampiran SPTJM Verifikasi SPJ TAMSIL.');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('Upload Lampiran SPTJM Verifikasi SPJ Tamsil.');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
