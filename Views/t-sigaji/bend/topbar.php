        ...
        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <?php if (isset($user)) { ?>
                        <li class="nav-item">
                            <a class="nav-link <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "home") ? ' active-menu-href' : '' ?>" href="<?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "home") ? 'javascript:;' : base_url('sigaji/bend/home') ?>">
                                <i class="bx bx-home-circle me-2"></i>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "masterdata") ? ' active-menu-href' : '' ?>" href="#" id="topnav-masterdata" role="button">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-masterdata">
                                <a href="<?= base_url('sigaji/bend/masterdata/pegawai') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "masterdata" && $uri->getSegment(4) == "pegawai") ? ' active-menu-href' : '' ?>" key="t-masterdata-pegawai">Pegawai</a>
                                <!-- <a href="<?= base_url('sigaji/bend/masterdata/ptk') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "masterdata" && $uri->getSegment(4) == "ptk") ? ' active-menu-href' : '' ?>" key="t-masterdata-ptk">PTK</a> -->
                                <!-- <a href="<?= base_url('sigaji/bend/masterdata/refgaji') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "masterdata" && $uri->getSegment(4) == "refgaji") ? ' active-menu-href' : '' ?>" key="t-masterdata-refgaji">Referensi Gaji</a> -->
                                <a href="<?= base_url('sigaji/bend/masterdata/refbulan') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "masterdata" && $uri->getSegment(4) == "refbulan") ? ' active-menu-href' : '' ?>" key="t-masterdata-refbulan">Referensi Tahun Bulan</a>
                                <!-- <a href="<?= base_url('sigaji/bend/masterdata/pengguna') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "masterdata" && $uri->getSegment(4) == "pengguna") ? ' active-menu-href' : '' ?>" key="t-masterdata-pengguna">Pengguna</a> -->
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "potongan") ? ' active-menu-href' : '' ?>" href="#" id="topnav-rekap" role="button">
                                <i class="bx bx-rename me-2"></i><span key="t-potongan">POTONGAN</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-potongan">
                                <a href="<?= base_url('sigaji/bend/potongan/korpri') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "potongan" && $uri->getSegment(4) == "korpri") ? ' active-menu-href' : '' ?>" key="t-potongan-korpri">Korpri</a>
                                <a href="<?= base_url('sigaji/bend/potongan/dharmawanita') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "potongan" && $uri->getSegment(4) == "dharmawanita") ? ' active-menu-href' : '' ?>" key="t-potongan-dharmawanita">Dharma Wanita</a>
                                <a href="<?= base_url('sigaji/bend/potongan/infak') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "potongan" && $uri->getSegment(4) == "infak") ? ' active-menu-href' : '' ?>" key="t-potongan-infak">Infak</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "upload") ? ' active-menu-href' : '' ?>" href="#" id="topnav-upload" role="button">
                                <i class="bx bxs-cloud-upload me-2"></i><span key="t-upload">UPLOAD</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-upload">
                                <a href="<?= base_url('sigaji/bend/upload/pegawai') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "upload" && $uri->getSegment(4) == "pegawai") ? ' active-menu-href' : '' ?>" key="t-upload-pegawai">Gaji SIPD</a>
                                <!-- <a href="<?= base_url('sigaji/bend/upload/gajisipd') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "upload" && $uri->getSegment(4) == "gajisipd") ? ' active-menu-href' : '' ?>" key="t-upload-gajisipd">Gaji SIPD</a> -->
                                <a href="<?= base_url('sigaji/bend/upload/tagihanbank') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "upload" && $uri->getSegment(4) == "tagihanbank") ? ' active-menu-href' : '' ?>" key="t-upload-tagihanbank">Tagihan Bank</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-gagal">
                                <a href="<?= base_url('sigaji/bend/gagal/uploadtagihan') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "gagal" && $uri->getSegment(4) == "uploadtagihan") ? ' active-menu-href' : '' ?>" key="t-gagalupload-tagihanbank">Tagihan Bank</a>
                                <a href="<?= base_url('sigaji/bend/gagal/uploadinstansi') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "gagal" && $uri->getSegment(4) == "uploadinstansi") ? ' active-menu-href' : '' ?>" key="t-gagalupload-updateinstansi">Update Instansi</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "rekap") ? ' active-menu-href' : '' ?>" href="#" id="topnav-rekap" role="button">
                                <i class="bx bx-rename me-2"></i><span key="t-rekap">REKAP</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-rekap">
                                <a href="<?= base_url('sigaji/bend/rekap/tagihan') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "rekap" && $uri->getSegment(4) == "tagihan") ? ' active-menu-href' : '' ?>" key="t-rekap-tagihan">Tagihan</a>
                                <a href="<?= base_url('sigaji/bend/rekap/laporaninstansi') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "bend" && $uri->getSegment(3) == "rekap" && $uri->getSegment(4) == "laporaninstansi") ? ' active-menu-href' : '' ?>" key="t-rekap-laporaninstansi">Laporan Per Instansi</a>
                            </div>
                        </li>
                        <!-- <li class="nav-item dropdown">
