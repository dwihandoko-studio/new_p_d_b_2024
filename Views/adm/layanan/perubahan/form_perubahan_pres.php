                                                ...
                                                <div class="col-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select onchange="kategoriAkademik(this)" class="default-select form-control wide" style="width: 100%;" id="_kategori_akademik" name="_kategori_akademik">
                                                            <option value="">-- Pilih --</option>
                                                            <option value="sains" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->kategori == 'sains' ? ' selected' : '') : '') : '' ?>>Sains</option>
                                                            <option value="teknologi" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->kategori == 'teknologi' ? ' selected' : '') : '') : '' ?>>Teknologi</option>
                                                            <option value="riset" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->kategori == 'riset' ? ' selected' : '') : '') : '' ?>>Riset</option>
                                                            <option value="inovasi" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->kategori == 'inovasi' ? ' selected' : '') : '') : '' ?>>Inovasi</option>
                                                        </select>
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select onchange="tingkatAkademik(this)" class="default-select form-control wide" style="width: 100%;" id="_tingkat_akademik" name="_tingkat_akademik">
                                                            <option value="">-- Pilih --</option>
                                                            <option value="kecamatan" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->tingkat == 'kecamatan' ? ' selected' : '') : '') : '' ?>>Kecamatan</option>
                                                            <option value="kabupaten" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->tingkat == 'kabupaten' ? ' selected' : '') : '') : '' ?>>Kabupaten</option>
                                                            <option value="provinsi" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->tingkat == 'provinsi' ? ' selected' : '') : '') : '' ?>>Provinsi</option>
                                                            <option value="nasional" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->tingkat == 'nasional' ? ' selected' : '') : '') : '' ?>>Nasional</option>
                                                            <option value="internasional" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->tingkat == 'internasional' ? ' selected' : '') : '') : '' ?>>Internasional</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select onchange="penyelenggaraAkademik(this)" class="default-select form-control wide" style="width: 100%;" id="_penyelenggara_akademik" name="_penyelenggara_akademik">
                                                            <option value="">-- Pilih --</option>
                                                            <option value="pusat" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->penyelenggara == 'pusat' ? ' selected' : '') : '') : '' ?>>Pemerintah Pusat</option>
                                                            <option value="daerah" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->penyelenggara == 'daerah' ? ' selected' : '') : '') : '' ?>>Pemerintah Daerah</option>
                                                            <option value="bumn" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->penyelenggara == 'bumn' ? ' selected' : '') : '') : '' ?>>Badan Usaha Milik Negara (BUMN)</option>
                                                            <option value="bumd" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->penyelenggara == 'bumd' ? ' selected' : '') : '') : '' ?>>Badan Usaha Milik Daerah (BUMD)</option>
                                                            <option value="lainnya" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->penyelenggara == 'lainnya' ? ' selected' : '') : '') : '' ?>>Lembaga Lainnya</option>
                                                        </select>
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select onchange="juaraAkademik(this)" class="default-select form-control wide" style="width: 100%;" id="_juara_akademik" name="_juara_akademik">
                                                            <option value="">-- Pilih --</option>
                                                            <option value="1" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->juara == '1' ? ' selected' : '') : '') : '' ?>>Juara 1</option>
                                                            <option value="2" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->juara == '2' ? ' selected' : '') : '') : '' ?>>Juara 2</option>
                                                            <option value="3" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "akademik" ? ($dokument->prestasi_akademik->juara == '3' ? ' selected' : '') : '') : '' ?>>Juara 3</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select onchange="kategoriNonakademik(this)" class="default-select form-control wide" style="width: 100%;" id="_kategori_nonakademik" name="_kategori_nonakademik">
                                                            <option value="">-- Pilih --</option>
                                                            <option value="senibudaya" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->kategori == 'senibudaya' ? ' selected' : '') : '') : '' ?>>Seni Budaya</option>
                                                            <option value="olahraga" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->kategori == 'olahraga' ? ' selected' : '') : '') : '' ?>>Olah Raga</option>
                                                            <option value="pramuka" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->kategori == 'pramuka' ? ' selected' : '') : '') : '' ?>>Pramuka</option>
                                                            <option value="tahfidz" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->kategori == 'tahfidz' ? ' selected' : '') : '') : '' ?>>Tahfidz</option>
                                                        </select>
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        <label for="_kec" class="col-form-label">Tingkat:</label>
                                                        <select onchange="tingkatNonakademik(this)" class="default-select form-control wide" style="width: 100%;" id="_tingkat_nonakademik" name="_tingkat_nonakademik">
                                                            <option value="">-- Pilih --</option>
                                                            <option value="kecamatan" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->tingkat == 'kecamatan' ? ' selected' : '') : '') : '' ?>>Kecamatan</option>
                                                            <option value="kabupaten" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->tingkat == 'kabupaten' ? ' selected' : '') : '') : '' ?>>Kabupaten</option>
                                                            <option value="provinsi" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->tingkat == 'provinsi' ? ' selected' : '') : '') : '' ?>>Provinsi</option>
                                                            <option value="nasional" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->tingkat == 'nasional' ? ' selected' : '') : '') : '' ?>>Nasional</option>
                                                            <option value="internasional" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->tingkat == 'internasional' ? ' selected' : '') : '') : '' ?>>Internasional</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select onchange="penyelenggaraNonakademik(this)" class="default-select form-control wide" style="width: 100%;" id="_penyelenggara_nonakademik" name="_penyelenggara_nonakademik">
                                                            <option value="">-- Pilih --</option>
                                                            <option value="pusat" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->penyelenggara == 'pusat' ? ' selected' : '') : '') : '' ?>>Pemerintah Pusat</option>
                                                            <option value="daerah" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->penyelenggara == 'daerah' ? ' selected' : '') : '') : '' ?>>Pemerintah Daerah</option>
                                                            <option value="bumn" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->penyelenggara == 'bumn' ? ' selected' : '') : '') : '' ?>>Badan Usaha Milik Negara (BUMN)</option>
                                                            <option value="bumd" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->penyelenggara == 'bumd' ? ' selected' : '') : '') : '' ?>>Badan Usaha Milik Daerah (BUMD)</option>
                                                            <option value="lainnya" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->penyelenggara == 'lainnya' ? ' selected' : '') : '') : '' ?>>Lembaga Lainnya</option>
                                                        </select>
                                                    </div>
                                                    <div class="input-group mb-3">
                                                        <label for="_kec" class="col-form-label">Juara:</label>
                                                        <select onchange="juaraNonakademik(this)" class="default-select form-control wide" style="width: 100%;" id="_juara_nonakademik" name="_juara_nonakademik">
                                                            <option value="">-- Pilih --</option>
                                                            <option value="1" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->juara == '1' ? ' selected' : '') : '') : '' ?>>Juara 1</option>
                                                            <option value="2" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->juara == '2' ? ' selected' : '') : '') : '' ?>>Juara 2</option>
                                                            <option value="3" <?= isset($dokument->prestasi_dimiliki) ? ($dokument->prestasi_dimiliki == "nonakademik" ? ($dokument->prestasi_nonakademik->juara == '3' ? ' selected' : '') : '') : '' ?>>Juara 3</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
