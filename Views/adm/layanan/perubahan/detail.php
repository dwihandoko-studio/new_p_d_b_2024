                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-4 mb-2">
                                <button type="button" onclick="aksiPerubahan('<?= $data->id ?>', '<?= $data->kode_pendaftaran ?>', '<?= replaceTandaBacaPetik($data->nama_peserta) ?>')" class="btn btn-block btn-xs btn-info waves-effect waves-light"><i class="fas fa-business-time font-size-16 align-middle me-2" style="font-size: 1.5rem !important;"></i> Layanan Cabut Berkas Verifikasi</button>
                            </div>
                        </div>
                    </div>
                </div>
