...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            ...
            <button type="button" class="btn btn-sm btn-primary waves-effect waves-light btnadd"><i class="fas fa-plus-square font-size-16 align-middle me-2"></i> TAMBAH KELURAHAN</button> &nbsp;&nbsp;
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Referensi Kelurahan</h4>
