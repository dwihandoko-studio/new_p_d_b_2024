...
<head>
    ...
    <meta name="keywords" content="PPDB Kab. Lampung Tengah, PPDB 2024 Lampung Tengah, Disdikbud, disdik, dinas pendidikan, Dinas Pendidikan dan Kebudayaan, Dinas Pendidikan dan Kebudayaan Kabupaten Lampung Tengah" />
    <meta name="author" content="esline.id" />
    <meta name="description" content="PPDB Kab. Lampung Tengah Dinas Pendidikan dan Kebudayaan Kabupaten Lampung Tengah" />
    <meta property="og:url" content="<?= base_url() ?>" />
    <meta property="og:title" content="PPDB Kab. Lampung Tengah Disdikbud Kab. Lampung Tengah" />
    <meta property="og:description" content="PPDB Kab. Lampung Tengah Dinas Pendidikan dan Kebudayaan Kabupaten Lampung Tengah" />
...
<body>
    ...
    <div id="main-wrapper">
        <div class="nav-header">
            <a href="<?= base_url('pd/home') ?>" class="brand-logo">
	...
	Chat box End
***********************************-->
        <?= $this->include('t-ppdb/pd/topbar'); ?>
        <?= $this->include('t-ppdb/pd/menu'); ?>

        <?= $this->renderSection('content'); ?>
        <?= $this->include('t-ppdb/pd/footer'); ?>
    </div>
