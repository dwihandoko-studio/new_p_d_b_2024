<div class="dlabnav">
    <div class="dlabnav-scroll">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a href="<?= base_url('sek/ppdb/profilsek') ?>" class="" aria-expanded="false">
                    <i class="las la-school"></i>
                    <span class="nav-text">Profil Sekolah</span>
                </a>
            </li>
            <li><a href="<?= base_url('sek/ppdb/pendaftar') ?>" class="" aria-expanded="false">
            ...
            <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?= base_url('sek/ppdb/rekap/lolos') ?>">Lolos Verifikasi Berkas</a></li>
                    <li><a href="<?= base_url('sek/ppdb/rekap/tolak') ?>">Tidak Lolos Verifikasi Berkas</a></li>
                </ul>
            </li>
            <li><a href="<?= base_url('sek/ppdb/laporan') ?>" class="" aria-expanded="false">
