<div class="dlabnav">
    <div class="dlabnav-scroll">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a href="<?= base_url('sek/verval/panitia') ?>" class="" aria-expanded="false">
                    <i class="fas fa-sitemap"></i>
                    <span class="nav-text">Panitia PPDB Sekolah</span>
                </a>
            </li>
            <li><a href="<?= base_url('sek/verval/pd') ?>" class="" aria-expanded="false">
                    <i class="fas fa-book-reader"></i>
                    <span class="nav-text">PD Tingkat Akhir</span>
                </a>
            </li>
            <li><a href="<?= base_url('sek/verval/pd/edit') ?>" class="" aria-expanded="false">
                    <i class="fas fa-address-card"></i>
                    <span class="nav-text">Edit Domisili</span>
                </a>
            </li>
            <li><a href="<?= base_url('sek/verval/akun') ?>" class="" aria-expanded="false">
