...
{
    protected $table = "ref_kelurahan b";
    protected $column_order = array(null, null, 'b.id', 'b.nama', 'b.id_kecamatan');
    ...
    function get_datatables()
    {
        ...
        if ($this->request->getPost('kec')) {
            ...
            if ($kec !== "") {
                $this->dt->where('b.id_kecamatan', $kec);
            } else {
                $this->dt->where("LEFT(b.id_kecamatan,4) = '1202");
            }
        } else {
            $this->dt->where("LEFT(b.id_kecamatan,4) = '1202'");
        }
