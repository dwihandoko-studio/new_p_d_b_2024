...
namespace App\Models\Adm\Validasi;
...
class SekolahpdModel extends Model
{
    ...
    {
        $this->dt->select("a.sekolah_id, a.nama, a.npsn, a.bentuk_pendidikan, a.bentuk_pendidikan_id, a.kecamatan, a.kode_kecamatan, (SELECT count(peserta_didik_id) FROM dapo_peserta WHERE sekolah_id = a.sekolah_id) AS total, (SELECT count(peserta_didik_id) FROM dapo_peserta WHERE dusun IS NOT NULL AND sekolah_id = a.sekolah_id) AS verified, (SELECT count(peserta_didik_id) FROM dapo_peserta WHERE dusun IS NULL AND sekolah_id = a.sekolah_id) AS notverified, (SELECT count(peserta_didik_id) FROM _users_profile_pd WHERE sekolah_id_asal = a.sekolah_id) AS generate");
