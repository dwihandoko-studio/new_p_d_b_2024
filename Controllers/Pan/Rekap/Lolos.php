...
namespace App\Controllers\Pan\Rekap;
...
class Lolos extends BaseController
{
    ...
    public function getAll()
    {
        ...
        foreach ($lists as $list) {
            ...
            //                 </div>
            //             </div>';
            $action = '<a href="' . base_url() . '/pan/rekap/lolos/detail?d=' . $list->id . '&t=' . $list->kode_pendaftaran . '" class="btn btn-xs btn-primary waves-effect waves-light"><i class="las la-eye font-size-16 align-middle me-2" style="font-size: 1.5rem !important;"></i> DETAIL</a>';
    ...
    {
        return redirect()->to(base_url('pan/rekap/lolos/data'));
    }
    ...
    public function data()
    {
        ...
        return view('pan/rekap/lolos/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$oldData) {
            return redirect()->to(base_url('pan/rekap/lolos'));
        }
        ...
        if ($oldData->via_jalur == "PRESTASI") {
            return view('pan/rekap/lolos/detail_pres', $data);
        } else {
            return view('pan/rekap/lolos/detail', $data);
        }
    }
}
