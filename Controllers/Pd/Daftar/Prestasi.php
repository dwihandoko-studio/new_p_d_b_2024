    ...
    public function data()
    {
        ...
        if ($cekAvailableRegisteredTidakLolos) {
            if ($cekAvailableRegisteredTidakLolos->via_jalur === "AFIRMASI") {
                ...
                $hasRegisterTidakLolos->message = "Anda dinyatakan <b>TIDAK LOLOS</b> seleksi PPDB Tahun Ajaran 2023/2024 <br/>di : <b>" . $cekAvailableRegisteredTidakLolos->nama_sekolah_tujuan . "(" . $cekAvailableRegisteredTidakLolos->npsn_sekolah_tujuan . ")</b> Melalui Jalur <b>" . $cekAvailableRegcekAvailableRegisteredTidakLolosistered->via_jalur . "</b>. <br/>Selanjutnya anda dapat mendaftar kembali menggunakan jalur yang lain (ZONASI, PRESTASI, MUTASI)";
