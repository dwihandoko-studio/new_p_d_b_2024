...
use App\Models\Su\Setting\ZonasiModel;
use App\Models\Su\Setting\SekolahzonaModel;
use Config\Services;
...
class Zonasi extends BaseController
{
    ...
    {
        return redirect()->to(base_url('su/setting/zonasi/data'));
    }
    ...
    public function data()
    {
        ...
        return view('su/setting/zonasi/sekolah', $data);
    }
    ...
    public function detaillist()
    {
        ...
        return view('su/setting/zonasi/index', $data);
    }
        ...
        if ($this->request->isAJAX()) {
            ...
            if (!$this->validate($rules)) {
                ...
                if (count($oldData) > 0) {
                    ...
                    $response->data = view('su/setting/zonasi/detail', $x);
                    return json_encode($response);
                }
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function add()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$this->validate($rules)) {
                ...
                $response->message = "Permintaan diizinkan";
                $response->data = view('su/setting/zonasi/add', $x);
                return json_encode($response);
            }
        } else {
            exit('Maaf tidak dapat diproses');
