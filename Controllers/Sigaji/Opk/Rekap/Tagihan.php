...
namespace App\Controllers\Sigaji\Opk\Rekap;

use App\Controllers\BaseController;
use App\Models\Sigaji\Opk\Rekap\TagihanModel;
use Config\Services;
...
extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/opk/rekap/tagihan/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/opk/rekap/tagihan/index', $data);
    }
    ...
    public function download()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sigaji/opk/rekap/tagihan/download', $data);
            return json_encode($response);
            // } else {
            //     $response = new \stdClass;
            //     $response->status = 400;
    ...
    public function detailbackbone()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/opk/masterdata/ptk/get_detail_backbone', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/opk/masterdata/ptk/edit', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
