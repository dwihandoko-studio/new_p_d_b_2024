...
use App\Models\Sigaji\Bend\Rekap\LaporaninstansiModel;
use Config\Services;
...
extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/bend/rekap/laporaninstansi/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/bend/rekap/laporaninstansi/index', $data);
    }
    ...
    public function download()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sigaji/bend/rekap/laporaninstansi/download', $data);
            return json_encode($response);
            // } else {
            //     $response = new \stdClass;
            //     $response->status = 400;
