...
use App\Models\Sigaji\Bank\Tagihan\TolakModel;
use Config\Services;
...
extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/bank/tagihan/tolak/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA TAGIHAN BANK TERTOLAK || TAK TERTAGIH';
        $Profilelib = new Profilelib();
        $user = $Profilelib->user();
        if ($user->status != 200) {
            delete_cookie('jwt');
        ...
        return view('sigaji/bank/tagihan/tolak/index', $data);
    }

    public function datadetail()
    {
        $data['title'] = 'DATA DETAIL TAGIHAN BANK TERTOLAK || TAK TERTAGIH';
        $Profilelib = new Profilelib();
        $user = $Profilelib->user();
        if ($user->status != 200) {
            delete_cookie('jwt');
        ...
        $data['datas'] = $this->_db->table('tb_tagihan_bank_antrian a')
            ->select("a.id, a.id_pegawai, a.instansi, a.keterangan_penolakan, a.kecamatan, a.besar_pinjaman, a.jumlah_tagihan, a.jumlah_bulan_angsuran, a.angsuran_ke, a.tahun, b.nama, b.nip, b.golongan, b.no_rekening_bank, b.kode_instansi, b.nama_instansi, b.nama_kecamatan, c.tahun, c.bulan")
    ...
    public function ambildataadd()
    {
        if ($this->request->isAJAX()) {
            ...
            $d['datas'] = $this->_db->table('tb_tagihan_bank_antrian a')
                ->select("a.id, a.status_ajuan, a.keterangan_penolakan, a.id_pegawai, a.instansi, a.kecamatan, a.besar_pinjaman, a.jumlah_tagihan, a.jumlah_bulan_angsuran, a.angsuran_ke, a.tahun, b.nama, b.nip, b.golongan, b.no_rekening_bank, b.kode_instansi, b.nama_instansi, b.nama_kecamatan, c.tahun, c.bulan")
                ->join('_ref_tahun_bulan c', 'a.tahun = c.id')
                ->join('tb_pegawai_ b', 'a.id_pegawai = b.id')
                ->where('a.dari_bank', $id_bank)
                ->where('a.tahun', $id)
