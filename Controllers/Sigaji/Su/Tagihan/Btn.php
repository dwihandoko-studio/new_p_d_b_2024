...
use App\Models\Sigaji\Su\Tagihan\BtnModel;
use Config\Services;
...
extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new BtnModel($request);
    ...
    {
        return redirect()->to(base_url('sigaji/su/tagihan/btn/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA TAGIHAN BTN';
        ...
        return view('sigaji/su/tagihan/btn/index', $data);
    }
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('sigaji/su/tagihan/btn/edit', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
