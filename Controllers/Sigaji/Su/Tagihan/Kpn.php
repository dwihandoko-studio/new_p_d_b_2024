...
use App\Models\Sigaji\Su\Tagihan\KpnModel;
use Config\Services;
...
extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new KpnModel($request);
    ...
    {
        return redirect()->to(base_url('sigaji/su/tagihan/kpn/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/su/tagihan/kpn/index', $data);
    }
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('sigaji/su/tagihan/kpn/edit', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
