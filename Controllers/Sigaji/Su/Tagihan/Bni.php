...
use App\Models\Sigaji\Su\Tagihan\BniModel;
use Config\Services;
...
extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new BniModel($request);
    ...
    {
        return redirect()->to(base_url('sigaji/su/tagihan/bni/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA TAGIHAN BNI';
        ...
        return view('sigaji/su/tagihan/bni/index', $data);
    }
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('sigaji/su/tagihan/bni/edit', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
