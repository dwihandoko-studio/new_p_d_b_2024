...
use App\Models\Sigaji\Su\Upload\MeninggalModel;
use Config\Services;
...
class Meninggal extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/su/upload/meninggal/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/su/upload/masterdata/meninggal/index', $data);
    }
