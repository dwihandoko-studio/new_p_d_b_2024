...
use App\Models\Sigaji\Su\Upload\ShodaqohModel;
use Config\Services;
...
class Shodaqoh extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/su/upload/shodaqoh/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/su/upload/masterdata/shodaqoh/index', $data);
    }
    ...
    public function upload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sigaji/su/upload/masterdata/shodaqoh/upload', $data);
            return json_encode($response);
        }
    }
