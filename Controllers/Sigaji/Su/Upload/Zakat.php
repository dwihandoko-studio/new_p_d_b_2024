...
use App\Models\Sigaji\Su\Upload\ZakatModel;
use Config\Services;
...
class Zakat extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/su/upload/zakat/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/su/upload/masterdata/zakat/index', $data);
    }
    ...
    public function upload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sigaji/su/upload/masterdata/zakat/upload', $data);
            return json_encode($response);
        }
    }
