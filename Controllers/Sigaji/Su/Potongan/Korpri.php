...
use App\Models\Sigaji\Su\Potongan\KorpriModel;
use Config\Services;
...
extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/su/potongan/korpri/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/su/potongan/korpri/index', $data);
    }
