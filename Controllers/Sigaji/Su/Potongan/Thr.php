...
use App\Models\Sigaji\Su\Potongan\ThrModel;
use Config\Services;
...
extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new ThrModel($request);
    ...
    {
        return redirect()->to(base_url('sigaji/su/potongan/thr/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA POTONGAN THR';
        ...
        return view('sigaji/su/potongan/thr/index', $data);
    }
    ...
    public function generate()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $apiLib = new Apilib();
            $result = $apiLib->generatePotonganThr($tahun);
            ...
            if ($result) {
                ...
                if ($result->status == 200) {
                    ...
                    $response->message = "Generate Potongan Thr Berhasil Dilakukan.";
                    return json_encode($response);
                } else {
                    $response = new \stdClass;
                    $response->status = 400;
                    $response->error = $result;
                    $response->message = "Gagal Generate Potongan Thr.";
                    return json_encode($response);
                }
            } else {
                $response = new \stdClass;
