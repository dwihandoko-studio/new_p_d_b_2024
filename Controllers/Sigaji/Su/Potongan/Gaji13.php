...
namespace App\Controllers\Sigaji\Su\Potongan;

use App\Controllers\BaseController;
use App\Models\Sigaji\Su\Potongan\Gaji13Model;
use Config\Services;
...
extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new Gaji13Model($request);
    ...
    {
        return redirect()->to(base_url('sigaji/su/potongan/gaji13/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA POTONGAN GAJI 13';
        ...
        return view('sigaji/su/potongan/gaji13/index', $data);
    }
    ...
    public function generate()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $apiLib = new Apilib();
            $result = $apiLib->generatePotonganGaji13($tahun);
            ...
            if ($result) {
                ...
                if ($result->status == 200) {
                    ...
                    $response->message = "Generate Potongan Gaji13 Berhasil Dilakukan.";
                    return json_encode($response);
                } else {
                    $response = new \stdClass;
                    $response->status = 400;
                    $response->error = $result;
                    $response->message = "Gagal Generate Potongan Gaji13.";
                    return json_encode($response);
                }
            } else {
                $response = new \stdClass;
