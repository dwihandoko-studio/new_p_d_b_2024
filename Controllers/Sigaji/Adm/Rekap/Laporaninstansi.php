...
namespace App\Controllers\Sigaji\Adm\Rekap;

use App\Controllers\BaseController;
use App\Models\Sigaji\Adm\Rekap\LaporaninstansiModel;
use Config\Services;
...
extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/adm/rekap/laporaninstansi/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/adm/rekap/laporaninstansi/index', $data);
    }
    ...
    public function download()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sigaji/adm/rekap/laporaninstansi/download', $data);
            return json_encode($response);
            // } else {
            //     $response = new \stdClass;
            //     $response->status = 400;
