...
use App\Models\Sigaji\Adm\Potongan\InfakModel;
use Config\Services;
...
extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/adm/potongan/infak/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/adm/potongan/infak/index', $data);
    }
