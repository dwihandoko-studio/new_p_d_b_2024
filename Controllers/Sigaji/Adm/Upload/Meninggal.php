...
use App\Models\Sigaji\Adm\Upload\MeninggalModel;
use Config\Services;
...
class Meninggal extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new MeninggalModel($request);
    ...
    {
        return redirect()->to(base_url('sigaji/adm/upload/meninggal/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA UPLOAD DATA MENINGGAL';
        ...
        return view('sigaji/adm/upload/masterdata/meninggal/index', $data);
    }
    ...
    public function upload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sigaji/adm/upload/masterdata/meninggal/upload', $data);
            return json_encode($response);
        }
    }
    ...
    public function uploadSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $apiLib = new Apilib();
            $result = $apiLib->uploadMeninggal($tahun, $fileLocation);
            $namaBank = "Data Meninggal";
            ...
            //     $response->data = view('sigaji/adm/upload/masterdata/tagihanbank/verifi-upload', $x);
