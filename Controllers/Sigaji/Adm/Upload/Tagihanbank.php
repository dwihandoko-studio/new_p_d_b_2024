...
use App\Models\Sigaji\Adm\Upload\TagihanbankModel;
use Config\Services;
...
class Tagihanbank extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/adm/upload/tagihanbank/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/adm/upload/masterdata/tagihanbank/index', $data);
    }
    ...
    public function upload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sigaji/adm/upload/masterdata/tagihanbank/upload', $data);
            return json_encode($response);
        }
    }
