...
use App\Models\Sigaji\Adm\Upload\ZakatModel;
use Config\Services;
...
class Zakat extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new ZakatModel($request);
    ...
    {
        return redirect()->to(base_url('sigaji/adm/upload/zakat/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA UPLOAD DATA ZAKAT';
        ...
        return view('sigaji/adm/upload/masterdata/zakat/index', $data);
    }
    ...
    public function upload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sigaji/adm/upload/masterdata/zakat/upload', $data);
            return json_encode($response);
        }
    }
    ...
    public function uploadSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $apiLib = new Apilib();
            $result = $apiLib->uploadTagihanZakat($tahun, $fileLocation);
            $namaBank = "Data Zakat";
