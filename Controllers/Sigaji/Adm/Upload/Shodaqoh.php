...
use App\Models\Sigaji\Adm\Upload\ShodaqohModel;
use Config\Services;
...
class Shodaqoh extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new ShodaqohModel($request);
    ...
    {
        return redirect()->to(base_url('sigaji/adm/upload/shodaqoh/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA UPLOAD DATA SHODAQOH';
        ...
        return view('sigaji/adm/upload/masterdata/shodaqoh/index', $data);
    }
    ...
    public function upload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sigaji/adm/upload/masterdata/shodaqoh/upload', $data);
            return json_encode($response);
        }
    }
    ...
    public function uploadSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $apiLib = new Apilib();
            $result = $apiLib->uploadTagihanShodaqoh($tahun, $fileLocation);
            $namaBank = "Data Shodaqoh";
            ...
            if ($result) {
                ...
                if ($result->status == 200) {
                    ...
                    $response->message = "Import $namaBank Berhasil Dilakukan.";
                    return json_encode($response);
                } else {
                    $response = new \stdClass;
                    $response->status = 400;
                    $response->error = $result;
                    $response->message = "Gagal Import $namaBank.";
                    return json_encode($response);
                }
            } else {
                $response = new \stdClass;
            ...
            //     $response->data = view('sigaji/su/upload/masterdata/tagihanbank/verifi-upload', $x);
