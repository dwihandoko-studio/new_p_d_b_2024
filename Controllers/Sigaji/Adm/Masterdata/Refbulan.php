...
use App\Models\Sigaji\Adm\RefbulanModel;
use Config\Services;
...
class Refbulan extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sigaji/adm/masterdata/refbulan/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sigaji/adm/masterdata/refbulan/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('sigaji/adm/masterdata/refbulan/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function add()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('sigaji/adm/masterdata/refbulan/add', $data);
            return json_encode($response);
            // } else {
            //     $response = new \stdClass;
            //     $response->status = 400;
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($this->_db->affectedRows() > 0) {
                ...
                $response->redirect = base_url('sigaji/adm/masterdata/refbulan');
                return json_encode($response);
            } else {
                // unlink($dir . '/' . $newNamelampiran);
                $this->_db->transRollback();
