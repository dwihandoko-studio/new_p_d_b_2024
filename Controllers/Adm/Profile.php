...
class Profile extends BaseController
{
    ...
    {
        return redirect()->to(base_url('adm/profile/data'));
    }
    ...
    public function data()
    {
        ...
        return view('adm/profile/index', $data);
            ...
            if (!$this->validate($rules)) {
                ...
                try {
                    ...
                    if ($this->_db->affectedRows() > 0) {
                        $this->_db->table('_users_profile_admin')->where('user_id', $user->data->id)->update($dataUserProfile);
                        if ($this->_db->affectedRows() > 0) {
