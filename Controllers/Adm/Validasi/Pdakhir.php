...
namespace App\Controllers\Adm\Validasi;

use App\Controllers\BaseController;
use App\Models\Adm\Validasi\PdModel;
use App\Models\Adm\Validasi\SekolahpdModel;
use Config\Services;
...
class Pdakhir extends BaseController
{
    ...
    {
        return redirect()->to(base_url('adm/validasi/pdakhir/data'));
    }

    public function data()
    {
        $data['title'] = 'PD Tingkat Akhir';
        ...
        return view('adm/validasi/pdakhir/sekolah', $data);
    }
    ...
    public function detaillist()
    {
        ...
        return view('adm/validasi/pdakhir/index', $data);
    }
