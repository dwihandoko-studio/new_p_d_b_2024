...
use App\Models\Situgu\Su\Tamsil\Upload\LanjutkantwModel;
use Config\Services;
...
class Lanjutkantw extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/su/upload/tamsil/lanjutkantw/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA MATCHING LANJUTKAN TW TAMSIL';
        ...
        return view('situgu/su/upload/tamsil/lanjutkantw/index', $data);
    }
    ...
    public function upload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('situgu/su/upload/tamsil/lanjutkantw/upload', $data);
            return json_encode($response);
        }
    }
