...
use App\Models\Situgu\Su\Spj\SpjtpgdetailModel;
use App\Models\Situgu\Su\Spj\SpjtpgsekolahModel;
use Config\Services;
...
class Tpg extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new SpjtpgsekolahModel($request);
    ...
    {
        $request = Services::request();
        $datamodel = new SpjtpgdetailModel($request);
    ...
    {
        return redirect()->to(base_url('situgu/su/spj/tpg/data'));
    }

    public function data()
    {
        $data['title'] = 'SPJ TUNJANGAN PROFESI GURU';
        ...
        return view('situgu/su/spj/tpg/index', $data);
    }
    ...
    public function datalist()
    {
        ...
        $data['tw'] = $this->_db->table('_ref_tahun_tw')->where('is_current', 1)->orderBy('tahun', 'desc')->orderBy('tw', 'desc')->get()->getRowObject();
        // $data['tws'] = $this->_db->table('_ref_tahun_tw')->orderBy('tahun', 'desc')->orderBy('tw', 'desc')->get()->getResult();
        return view('situgu/su/spj/tpg/detail_index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('situgu/su/spj/tpg/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
