...
use App\Models\Situgu\Su\SettinggrantedusulancustomModel;
use Config\Services;
use App\Libraries\Profilelib;
use App\Libraries\Apilib;

class Grantedusulancustom extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new SettinggrantedusulancustomModel($request);
    ...
    {
        return redirect()->to(base_url('situgu/su/setting/grantedusulancustom/data'));
    }

    public function data()
    {
        $data['title'] = 'GRANTED ACCESS USULAN CUSTOM';
        ...
        return view('situgu/su/setting/grantedusulancustom/index', $data);
    }
    ...
    public function add()
    {
        ...
        $response->status = 200;
        $response->message = "Permintaan diizinkan";
        $response->data = view('situgu/su/setting/grantedusulancustom/add', $d);
        return json_encode($response);
    }
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $cekData = $this->_db->table('granted_usulan_custom')->where(['id' => $pengguna])->get()->getRowObject();
            ...
            try {
                $this->_db->table('granted_usulan_custom')->insert($data);
    ...
    public function delete()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $this->_db->transBegin();
            try {
                $this->_db->table('granted_usulan_custom')->where('id', $id)->delete();
