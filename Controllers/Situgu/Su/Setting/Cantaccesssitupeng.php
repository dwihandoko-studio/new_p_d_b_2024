...
use App\Models\Situgu\Su\SettingcantaccesssitupengModel;
use Config\Services;
use App\Libraries\Profilelib;
use App\Libraries\Apilib;

class Cantaccesssitupeng extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new SettingcantaccesssitupengModel($request);
    ...
    {
        return redirect()->to(base_url('situgu/su/setting/cantaccesssitupeng/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/su/setting/cantaccesssitupeng/index', $data);
    }
    ...
    public function add()
    {
        ...
        $response->status = 200;
        $response->message = "Permintaan diizinkan";
        $response->data = view('situgu/su/setting/cantaccesssitupeng/add', $d);
        return json_encode($response);
    }
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $cekData = $this->_db->table('granted_cant_situpeng')->where(['id' => $pengguna])->get()->getRowObject();
            ...
            try {
                $this->_db->table('granted_cant_situpeng')->insert($data);
    ...
    public function delete()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $this->_db->transBegin();
            try {
                $this->_db->table('granted_cant_situpeng')->where('id', $id)->delete();
