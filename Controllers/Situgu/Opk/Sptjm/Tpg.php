...
class Tpg extends BaseController
{
    ...
    private function _download($ptks, $user, $tw, $userDetail)
    {
        if (count($ptks) > 0) {
            ...
            $template_processor->setImageValue('BARCODE', array('path' => 'http://192.168.33.16:8020/generate?data=https://layanan.disdikbud.lampungtengahkab.go.id/verifiqrcodev?token=' . $ptks[0]->kode_verifikasi, 'width' => 150, 'height' => 150, 'ratio' => false));
