            ...
            try {
                ...
                if ($this->_db->affectedRows() > 0) {
                    try {
                        ...
                        createAktifitas($user->data->id, "Menolak usulan Tamsil untuk PTK atas nama $nama dengan kode usulan: $oldData->kode_usulan, \nDengan keterangan: $keterangan", "Menolak usulan Tamsil PTK", "edit", $oldData->id_tahun_tw);
                        $getChatId = getChatIdTelegramPTK($oldData->id_ptk);
                        if ($getChatId) {
                            $admin = $user->data;
                            $tokenTele = "6504819187:AAEtykjIx2Gjd229nUgDHRlwJ5xGNTMjO0A";
