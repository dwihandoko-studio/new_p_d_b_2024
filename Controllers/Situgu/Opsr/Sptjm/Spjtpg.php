...
class Spjtpg extends BaseController
{
    ...
    public function getAll()
    {
        ...
        foreach ($lists as $list) {
            ...
            if ($list->is_locked == 1) {
                ...
                if ($list->lampiran_sptjm == null || $list->lampiran_sptjm == "") {
                    $row[] = '<a class="btn btn-sm btn-primary waves-effect waves-light" target="_blank" href="' . base_url('situgu/opsr/sptjm/spjtpg/download') . '?id=' . $list->kode_verifikasi . '"><i class="bx bxs-cloud-download font-size-16 align-middle me-2"></i> Download</a>&nbsp;&nbsp;'
    ...
    {
        return redirect()->to(base_url('situgu/opsr/sptjm/spjtpg/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opsr/sptjm/spjtpg/index', $data);
    }
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('situgu/opsr/sptjm/spjtpg/detail', $data);
            return json_encode($response);
        }
    }
    ...
    public function addGetTW()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if (count($tws) > 0) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/opsr/sptjm/spjtpg/get_tw', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function add()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/opsr/sptjm/spjtpg/add', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    {
        if (count($ptks) > 0) {
            $file = FCPATH . "upload/template/sptjm-verifikasi-spj-tpg-new-1.docx";
            ...
            $filed = FCPATH . "upload/generate/verifikasi/spjtpg/word/" . $ptks[0]->kode_verifikasi . ".docx";
    ...
    public function formuploadedit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opsr/sptjm/spjtpg/upload_edit', $data);
            return json_encode($response);
        }
    }
    ...
    public function formupload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opsr/sptjm/spjtpg/upload', $data);
            return json_encode($response);
        }
    }
