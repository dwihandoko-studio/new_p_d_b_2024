...
use App\Models\Situgu\Opsr\SptjmspjModel;
use Config\Services;
...
class Spjtamsil extends BaseController
{
    ...
    public function getAll()
    {
        ...
        foreach ($lists as $list) {
            ...
            if ($list->is_locked == 1) {
                ...
                if ($list->lampiran_sptjm == null || $list->lampiran_sptjm == "") {
                    $row[] = '<a class="btn btn-sm btn-primary waves-effect waves-light" target="_blank" href="' . base_url('situgu/opsr/sptjm/spjtamsil/download') . '?id=' . $list->kode_verifikasi . '"><i class="bx bxs-cloud-download font-size-16 align-middle me-2"></i> Download</a>&nbsp;&nbsp;'
    ...
    public function data()
    {
        ...
        return view('situgu/opsr/sptjm/spjtamsil/index', $data);
    }
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('situgu/opsr/sptjm/spjtamsil/detail', $data);
            return json_encode($response);
        }
    }
    ...
    public function addGetTW()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if (count($tws) > 0) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/opsr/sptjm/spjtamsil/get_tw', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function add()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/opsr/sptjm/spjtamsil/add', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function formuploadedit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opsr/sptjm/spjtamsil/upload_edit', $data);
            return json_encode($response);
        }
    }
    ...
    public function formupload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opsr/sptjm/spjtamsil/upload', $data);
            return json_encode($response);
        }
    }
