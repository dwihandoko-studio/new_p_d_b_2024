...
class Tamsil extends BaseController
{
    ...
    private function _download($ptks, $sekolah, $ks, $usulan)
    {
        if (count($ptks) > 0) {
            ...
            $template_processor->setImageValue('BARCODE', array('path' => 'https://chart.googleapis.com/chart?chs=70x70&cht=qr&chl=layanan.disdikbud.lampungtengahkab.go.id/verifiqrcode?token=' . $usulan->kode_usulan . '&choe=UTF-8', 'width' => 150, 'height' => 150, 'ratio' => false));
