...
class Pengumuman extends BaseController
{
    ...
    public function downloadsptjmzonmupres()
    {
        $Profilelib = new Profilelib();
        $user = $Profilelib->userSekolah();
        if ($user->status != 200) {
        ...
        $response = new \stdClass;
        $response->status = 200;
        $response->data = view('sek/ppdb/laporan/pengumuman/cetak-sptjm-zonmupres', $x);;
        $response->message = "SPTJM tersedia.";
        return json_encode($response);
    ...
    public function downloadlampiranzonmupres()
    {
        $Profilelib = new Profilelib();
        $user = $Profilelib->userSekolah();
        if ($user->status != 200) {
        ...
        $pesertaLolosZonasi = $this->_db->table('_tb_pendaftar a')
            ->select("a.*")
            ->where('a.tujuan_sekolah_id_1', $user->data->sekolah_id)
        ...
        $x['jalur'] = 'ZONASI, MUTASI & PRESTASI';
        $x['sekolah'] = $sekolah;
        $x['lolos_zonasi'] = $pesertaLolosZonasi;
        $x['gagal_zonasi'] = $pesertaTidakLolosZonasi;
        $x['lolos_mutasi'] = $pesertaLolosMutasi;
        $x['gagal_mutasi'] = $pesertaTidakLolosMutasi;
        $x['lolos_prestasi'] = $pesertaLolosPrestasi;
        $x['gagal_prestasi'] = $pesertaTidakLolosPrestasi;

        $response = new \stdClass;
        $response->status = 200;
        $response->data = view('sek/ppdb/laporan/pengumuman/cetak-lampiran-zonmupres', $x);;
        $response->message = "SPTJM tersedia.";
        return json_encode($response);
    ...
    public function downloadsptjmswasta()
    {
        ...
        $response = new \stdClass;
        $response->status = 200;
        $response->data = view('sek/ppdb/laporan/pengumuman/cetak-sptjm-swasta', $x);;
        $response->message = "SPTJM tersedia.";
        return json_encode($response);
    ...
    public function downloadlampiranswasta()
    {
        ...
        $response = new \stdClass;
        $response->status = 200;
        $response->data = view('sek/ppdb/laporan/pengumuman/cetak-lampiran-swasta', $x);;
        $response->message = "SPTJM tersedia.";
        return json_encode($response);
